...
cp -fr ${SCRIPT_DIR}/../_submodules/map/ ${SCRIPT_DIR}/.tmp/map
cp -fr ${SCRIPT_DIR}/../_submodules/ros-bridge/ ${SCRIPT_DIR}/.tmp/ros-bridge
...
docker build --force-rm -t ros_map_agent -f Dockerfile ${SCRIPT_DIR}/.
