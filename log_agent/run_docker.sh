...
${SCRIPT_DIR}/docker-gui \
    ...
    --volume=${SCRIPT_DIR}/recorder_replayer.py:/workspace/team_code/recorder_replayer.py:rw \
    --volume=${SCRIPT_DIR}/team_code/human_agent.py:/workspace/team_code/human_agent.py:rw \
